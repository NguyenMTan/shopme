    ...
    public class AppDbIntializer
    {
        public static void Seed(IApplicationBuilder applicationBuilder)
        {
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                if (!context.Brands.Any())
                {
                    context.Brands.AddRange(new List<Brand>()
                    {
                        ...
                        new Brand()
                        {
                            ...
                            NameBrand = "Dell",
                            Address = "Address Dell",
                            Phone = 987654321,
                            Email = "emailDell@gmail.com"
                        }
                    });
                ...
                if (!context.Products.Any())
                {
                    context.Products.AddRange(new List<Product>()
                    {
                        new Product()
                        {
                            ...
                            Quantity = 100,
                            Price = 10000000,
                            Description = "This is the description for HP 1",
                        ...
                        new Product()
                        {
                            ...
                            Quantity = 100,
                            Price = 9000000,
                            Description = "This is the description for Dell 1",
                            ProductCategory = ProductCategory.Laptop,
                            BrandId = 2
                        }
                    });
                ...
                //Order Details
                if (!context.Orders_Details.Any())
                {
                    context.Orders_Details.AddRange(new List<Order_Details>()
                    {
                        new Order_Details()
                        {
                            OrderId = 1,
